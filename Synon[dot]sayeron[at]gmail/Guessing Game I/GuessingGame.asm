...
prompt1     BYTE   cr,Lf,Lf,"Player 1, please enter a number from 0 to 1000:  ", 0
target      DWORD  ?
clear       BYTE   24 DUP (Lf), 0
prompt2     BYTE   cr,Lf,"Player 2, your guess? (your guess must be between 0 to 1000)   ", 0
...
untilValid: output prompt2          ; ask player 2 for guess
            input  stringIn, 20     ; get number
            atod   stringIn         ; convert to integer
			cmp    eax,0
			jl     untilValid
